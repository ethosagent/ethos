...
export const builtInCommands: SlashCommand[] = [
  ...
  { name: 'model', description: 'Show current model (switch requires restart)', usage: '/model [name]' },
  ...
  { name: 'verbose', description: 'Cycle or set output verbosity', usage: '/verbose [quiet|default|verbose|debug|status]' },
  { name: 'busy', description: 'Set busy-input mode', usage: '/busy [interrupt|queue|steer|status]' },
  ...
  { name: 'deny', description: 'Revoke an approved channel sender', usage: '/deny <platform> <id>' },
  { name: 'communications', description: 'List approved senders and pairing codes', usage: '/communications' },
