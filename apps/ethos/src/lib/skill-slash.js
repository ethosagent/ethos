 ...
 */
export async function scanSkillsIntoRegistry(storage, skillsDir, personalitySkillsDir, registry, skillCache) {
    const dirs = [skillsDir];
    if (personalitySkillsDir)
        dirs.push(personalitySkillsDir);
