...
export function App({
  ...
  const [userPinnedSkin, setUserPinnedSkin] = useState(() =>
  ...
  if (clarifyRequest) {
    ...
    return _jsx(SkinContext.Provider, {
      value: tokens,
      children: _jsx(ClarifyModal, {
        request: req,
        onAnswer: (answer) => {
  ...
  if (modal === 'sessions') {
    return _jsx(SkinContext.Provider, {
      value: tokens,
      children: _jsx(SessionPickerModal, {
        onSelect: (s) => {
          setSessionKey(s.key);
          setMessages([]);
          setCompletedTools([]);
  ...
  if (modal === 'models') {
    return _jsx(SkinContext.Provider, {
      value: tokens,
      children: _jsx(ModelPickerModal, {
  ...
  return _jsxs(SkinContext.Provider, {
    value: tokens,
    children: [
      _jsx(Static, {
        items: hudSnapshots,
                  ...
                  children: [
                    ...
                    _jsxs(Box, {
                      ...
                      children: [
                        ...
                        _jsx(SafetyLane, { readonlyMode: false, tags: [] }),
                        _jsx(FileActivityPanel, { entries: [] }),
                      ],
                    }),
                  ],
                }),
      ...
      _jsx(Static, {
        items: messages,
        children: (msg) => _jsx(ChatRow, { message: msg, accentColor: accentColor }, msg.id),
      }),
      _jsxs(Box, {
        flexDirection: 'column',
        children: [
          showSplash && inventory
            ...
            : _jsx(StreamingRow, { text: streamingText, accentColor: accentColor }),
          thinkingText &&
            _jsx(AccordionSection, {
              title: 'thinking',
              mode: resolveMode(details.thinking, details.global),
              children: _jsx(ThinkingPane, { text: thinkingText }),
            }),
          ...
          resolveMode(details.activity, details.global) !== 'hidden' &&
            ...
            _jsx(AccordionSection, {
              ...
              children: _jsx(ExecutionTimeline, {
                events: timelineEvents,
                focused: focusPane === 'timeline',
              }),
            }),
          delegations.length > 0 &&
            _jsx(AccordionSection, {
              ...
              children: _jsx(SubagentsPane, { delegations: delegations }),
            }),
          showKeymap &&
            _jsx(Box, {
              marginBottom: 1,
              children: _jsx(KeymapOverlay, { focusPane: focusPane, running: running }),
            }),
          statusMsg &&
            _jsx(Box, {
              marginBottom: 1,
              children: _jsx(Text, { dimColor: true, children: statusMsg }),
            }),
          completionVisible &&
            _jsx(CompletionPanel, { matches: completionMatches, selectedIndex: completionIndex }),
          _jsx(InputBox, {
            value: input,
            disabled: running,
            isActive:
          ...
          _jsx(StatusBar, {
            ...
            budgetState: budgetCapUsd != null ? { spent: usage.costUsd, cap: budgetCapUsd } : null,
          }),
        ],
      }),
    ],
