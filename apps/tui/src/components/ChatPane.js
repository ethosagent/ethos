      ...
      message.role === 'user'
        ? _jsxs(Box, {
            ...
            children: [
              ...
              _jsx(Text, { dimColor: true, children: tokens.glyphs.prompt }),
              _jsx(Text, { wrap: 'wrap', children: message.text }),
            ],
          })
        : _jsxs(Box, {
            gap: 1,
            children: [
              _jsx(Text, {
                color: message.accentColor ?? accentColor ?? tokens.semantic.success,
                children: tokens.glyphs.accentStripe,
              }),
...
export function StreamingRow({ text, accentColor }) {
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Text, {
        color: accentColor ?? tokens.semantic.success,
        children: tokens.glyphs.accentStripe,
      }),
      _jsx(Text, { bold: true, color: tokens.surface.textPrimary, children: 'ethos' }),
      _jsx(Text, { dimColor: true, children: tokens.glyphs.prompt }),
      _jsx(Text, { wrap: 'wrap', children: text }),
    ],
  });
}
