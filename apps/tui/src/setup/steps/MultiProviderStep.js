...
export function MultiProviderStep() {
  ...
  if (phase === 'add-provider') {
    return _jsxs(Box, {
      ...
      gap: 1,
      children: [
        _jsx(Text, { color: DESIGN.textPrimary, bold: true, children: 'Add a fallback provider:' }),
        _jsx(Box, {
          flexDirection: 'column',
          children: PROVIDER_CATALOG.map((p, i) => {
    ...
    return _jsxs(Box, {
      ...
      children: [
        _jsx(Text, {
          ...
          bold: true,
          children: `API key for ${entry?.label ?? ''}:`,
        }),
        _jsxs(Box, {
          flexDirection: 'row',
          gap: 1,
  ...
  return _jsxs(Box, {
    ...
    gap: 1,
    children: [
      _jsx(Text, { color: DESIGN.textPrimary, bold: true, children: 'Fallback provider chain:' }),
      _jsxs(Box, {
        flexDirection: 'column',
        marginLeft: 2,
        children: [
          _jsxs(Box, {
            ...
            children: [
              ...
              _jsx(Text, {
                color: DESIGN.textPrimary,
                children: `${answers.provider ?? 'anthropic'}`,
              }),
              _jsx(Text, { color: DESIGN.textTertiary, children: '(primary)' }),
            ],
          }),
          providers.map((p, i) =>
            _jsxs(
              Box,
              {
                ...
                gap: 1,
                children: [
                  _jsx(Text, { color: DESIGN.textSecondary, children: `  ${i + 1}. ` }),
                  _jsx(Text, { color: DESIGN.textSecondary, children: p.provider }),
                  _jsx(Text, { color: DESIGN.textTertiary, children: '(fallback)' }),
                ],
              },
              `${p.provider}-${i}`,
            ),
      ...
      _jsx(Box, {
        ...
        children: _jsx(Text, {
          ...
          children: '  a — add fallback   Enter done   Esc back',
        }),
      }),
    ],
  });
