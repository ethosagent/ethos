...
export function ModelStep() {
  ...
  return _jsxs(Box, {
    ...
    gap: 1,
    children: [
      _jsx(Text, { color: DESIGN.textPrimary, bold: true, children: 'Choose a default model:' }),
      _jsx(Box, {
        flexDirection: 'column',
            ...
            Box,
            {
              ...
              children: [
                ...
                _jsx(Text, {
                  ...
                  bold: isSelected,
                  children: m.modelId.padEnd(idWidth),
                }),
                _jsx(Text, { color: DESIGN.textTertiary, children: m.label.padEnd(labelWidth) }),
                _jsx(Text, {
                  color: isCurrent ? DESIGN.success : DESIGN.textTertiary,
                  children: ctxStr,
                }),
              ],
            },
      ...
      showWarning &&
        _jsx(Text, {
          ...
          children: `  ! ${selectedModel.contextWindow / 1_000}k ctx — researcher / engineer personalities work better at ≥64k`,
        }),
      models.length === 0 &&
        _jsxs(Box, {
          flexDirection: 'column',
          children: [
            _jsx(Text, {
              ...
              children: '  No known models for this provider. Enter a model ID:',
            }),
            _jsx(Text, { color: DESIGN.textTertiary, children: '  (free-form entry coming soon)' }),
          ],
        }),
      _jsx(Text, {
        color: DESIGN.textTertiary,
