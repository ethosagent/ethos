...
export function DaemonInstallStep() {
    ...
    return (_jsxs(Box, { flexDirection: "column", gap: 1, children: [_jsx(Text, { color: DESIGN.textPrimary, bold: true, children: "Gateway daemon:" }), _jsx(Text, { color: DESIGN.textTertiary, children: `  Detected: ${platform}` }), _jsx(Box, { flexDirection: "column", marginTop: 1, children: OPTIONS.map((opt, i) => {
