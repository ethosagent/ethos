          ...
          ? _jsxs(Box, {
              ...
              children: [
                _jsx(Text, {
                  ...
                  children: '  Resource URL from the Azure portal (Keys and Endpoint).',
                }),
                _jsxs(Box, {
                  flexDirection: 'row',
                  gap: 1,
                  marginTop: 1,
                  children: [
                    _jsx(Text, { color: DESIGN.textPrimary, children: `  ${GLYPHS.prompt} ` }),
                    _jsx(Text, {
                      color: endpoint ? DESIGN.textPrimary : DESIGN.textTertiary,
                      children: endpoint || 'https://my-resource.openai.azure.com',
                    }),
                  ],
                }),
                error &&
                  _jsx(Text, { color: DESIGN.error, children: `  ${GLYPHS.toolFail} ${error}` }),
              ],
            })
          : _jsxs(Box, {
              flexDirection: 'column',
              children: [
                _jsx(Text, { color: DESIGN.textTertiary, children: `  Endpoint: ${endpoint}` }),
                _jsxs(Box, {
                  flexDirection: 'row',
                  gap: 1,
                  marginTop: 1,
                  children: [
                    _jsx(Text, { color: DESIGN.textPrimary, children: `  ${GLYPHS.prompt} ` }),
                    _jsx(Text, {
                      color: maskedKey ? DESIGN.textPrimary : DESIGN.textTertiary,
                      children: maskedKey || '(paste key — input is hidden)',
                    }),
                  ],
                }),
                error &&
        ...
        ? _jsxs(Box, {
            ...
            children: [
              _jsx(Text, {
                ...
                children: `  Base URL: ${answers.baseUrl ?? 'http://localhost:11434/v1'}`,
              }),
              _jsx(Text, {
                color: DESIGN.textTertiary,
                children: '  No API key required for local models.',
              }),
            ],
          })
        : _jsxs(Box, {
            flexDirection: 'column',
            children: [
              signupNote && _jsx(Text, { color: DESIGN.textTertiary, children: `  ${signupNote}` }),
              _jsxs(Box, {
                flexDirection: 'row',
                gap: 1,
                marginTop: 1,
              ...
              !apiKeyValue &&
                _jsx(Text, {
                  color: DESIGN.textTertiary,
                  children: '  Tip: you can add a key later by editing ~/.ethos/config.yaml',
                }),
              error &&
                _jsx(Text, { color: DESIGN.error, children: `  ${GLYPHS.toolFail} ${error}` }),
            ],
          }),
      _jsx(Text, { color: DESIGN.textTertiary, children: '  Enter confirm   Esc back' }),
    ],
  });
}
