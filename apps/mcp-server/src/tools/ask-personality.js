...
export async function askPersonality(loop, args) {
...
export const askPersonalityToolDef = {
    ...
    description: 'Run a prompt through a specific Ethos personality and return the response. Each personality has a distinct identity, toolset, and memory scope.',
    inputSchema: {
        type: 'object',
        properties: {
            personality_id: {
            ...
            session_key: {
                type: 'string',
                description: 'Optional session key for conversation continuity. Omit to start a fresh session.',
            },
        },
