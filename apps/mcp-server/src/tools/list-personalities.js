...
export function listPersonalities(dataDir) {
    ...
    const builtinDir = join(new URL('../../..', import.meta.url).pathname, 'extensions', 'personalities', 'data');
...
export const listPersonalitiesToolDef = {
    ...
    description: 'List all available Ethos personalities with their IDs, descriptions, and allowed tools.',
    inputSchema: {
        type: 'object',
        properties: {},
        required: [],
