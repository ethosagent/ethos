...
export function searchMemory(dataDir, query, scope) {
    const results = [];
...
export const searchMemoryToolDef = {
    name: 'search_memory',
    description: 'Search Ethos agent memory files (MEMORY.md and USER.md) for entries matching a query. Returns matching snippets with surrounding context.',
    inputSchema: {
        type: 'object',
        properties: {
            query: {
