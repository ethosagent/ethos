...
export const skillsRouter = {
    ...
    create: os.skills.create.handler(({ input, context }) => context.skills.create({ id: input.id, body: input.body })),
    update: os.skills.update.handler(({ input, context }) => context.skills.update({ id: input.id, body: input.body })),
