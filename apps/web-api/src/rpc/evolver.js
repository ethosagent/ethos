...
export const evolverRouter = {
    ...
    configUpdate: os.evolver.configUpdate.handler(({ input, context }) => context.evolver.updateConfig(input)),
    ...
    history: os.evolver.history.handler(({ input, context }) => context.evolver.listHistory(input.limit)),
};
