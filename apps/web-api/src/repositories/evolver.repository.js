...
export class EvolverRepository {
    ...
    async setConfig(config) {
        ...
        const merged = {
            rewriteThreshold: clamp(config.rewriteThreshold, 0, 1, DEFAULT_EVOLVE_CONFIG.rewriteThreshold),
            newSkillPatternThreshold: clamp(config.newSkillPatternThreshold, 0, 1, DEFAULT_EVOLVE_CONFIG.newSkillPatternThreshold),
