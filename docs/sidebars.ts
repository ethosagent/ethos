...
const sidebars: SidebarsConfig = {
  docsSidebar: [
    ...
    },
    {
      ...
      items: [
        'skills/overview',
        'skills/per-personality-filter',
        {
          type: 'category',
          label: 'Built-in: Coding',
          collapsed: false,
          items: [
            'skills/built-in-coding/index',
            'skills/built-in-coding/plan',
            'skills/built-in-coding/writing-plans',
            'skills/built-in-coding/spike',
            'skills/built-in-coding/tdd',
            'skills/built-in-coding/code-review',
            'skills/built-in-coding/systematic-debugging',
            'skills/built-in-coding/github-pr-workflow',
            'skills/built-in-coding/github-code-review',
            'skills/built-in-coding/coding-agent',
            'skills/built-in-coding/subagent-driven-development',
          ],
        },
      ],
    },
