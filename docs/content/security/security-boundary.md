...
- **Enforced at.** [`resolve-execution-posture.ts:250`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L250) (`resolveExecutionPosture`, the posture selection), with the build-impossible branch at [`:306`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L307), the `hostFallback` labelling at [`:345`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L346), the daemon-unavailable decision at [`:411`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L412), and the unmet-remote-requirement refusal at [`:388`](https://github.com/ethosagent/ethos/blob/main/packages/wiring/src/resolve-execution-posture.ts#L389).
