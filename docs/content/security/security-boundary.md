...
**Tier 2 — extensions, not owned.** The remaining 106 packages. Best-effort. A bug is a bug, not a CVE. They inherit exactly what the kernel enforces and nothing more.
