...
export function createVideoAnalyzeTool(opts) {
    return {
        name: 'video_analyze',
        description: 'Analyze a video via URL. Ask questions about video content, extract information, ' +
        ...
        schema: {
            ...
            properties: {
                ...
                prompt: {
                    type: 'string',
                    description: 'Question or instruction about the video (default: "Describe this video in detail.")',
                },
        ...
        async execute(args, ctx) {
            ...
            if (!supportsVideoUrl(resolvedModel)) {
                return {
                    ok: false,
                    error: `VIDEO_NOT_SUPPORTED: model '${resolvedModel}' does not support video input. ` +
