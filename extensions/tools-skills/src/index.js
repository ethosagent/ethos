export function createSkillsTools(opts) {
    const skillsListTool = {
        name: 'skills_list',
        description: 'List all available skills the current personality has access to. Returns name, description, and kind for each.',
        toolset: 'skills',
    ...
    const skillViewTool = {
        name: 'skill_view',
        description: 'View the full content of a skill by name. Use skills_list first to discover available skills.',
        toolset: 'skills',
