...
export const webSearchTool = {
    name: 'web_search',
    description: 'Search the web for current information. Returns titles, URLs, and text snippets. Requires ETHOS_EXA_API_KEY environment variable.',
    toolset: 'web',
...
export const webExtractTool = {
    name: 'web_extract',
    description: 'Fetch a URL and extract its text content. Use to read articles, documentation, or any web page.',
    toolset: 'web',
