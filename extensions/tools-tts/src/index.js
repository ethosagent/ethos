export function createTtsTools(opts) {
    const textToSpeechTool = {
        name: 'text_to_speech',
        description: 'Convert text to speech audio. Returns audio data that channel adapters will deliver as a voice message. Requires a TTS provider to be configured.',
        toolset: 'voice',
        maxResultChars: 1024,
        capabilities: {},
        schema: {
