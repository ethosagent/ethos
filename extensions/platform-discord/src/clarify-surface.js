...
import { clarifyModalPayload, clarifyPendingMessage, clarifyResolvedMessage, } from './clarify-blocks';
...
export class DiscordClarifySurface {
    ...
    rememberResponder(requestId, userId) {
        if (this.responderById.size >= 1024) {
            ...
            if (first !== undefined)
                this.responderById.delete(first);
        }
