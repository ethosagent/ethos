...
import type { Storage, StorageDirEntry, StorageRemoveOptions, StorageWriteOptions } from '@ethosagent/types'
...
export class CryptoStorage implements Storage {
  ...
  async write(path: string, content: string | Uint8Array, opts?: StorageWriteOptions): Promise<void> {
