...
// ---------------------------------------------------------------------------
// Discriminated union for parsed schedule
// ---------------------------------------------------------------------------

export type ParsedSchedule =
  | { kind: 'cron'; expression: string }
  | { kind: 'relative'; delayMs: number }
...
function parseTimeUnit(value: number, unit: string): number {
 ...
 */
export function nextRunFromParsed(
...
export function nextRunForSchedule(raw: string, after: Date, createdAt?: Date): Date | null {
