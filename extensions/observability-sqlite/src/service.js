...
export class ObservabilityService {
    ...
    startTrace(opts) {
        ...
        if (this.isDisabled?.())
            return traceId; // suppress writes during reset window
        const trace = {
            traceId,
    ...
    startSpan(opts) {
        ...
        if (this.isDisabled?.())
            return spanId; // suppress writes during reset window
        const span = {
            spanId,
    ...
    async recordSnapshot(opts) {
        if (this.isDisabled?.())
            return randomUUID(); // suppress writes during reset window
