...
## Memory
- Memory scope: personality:outbound-gated
...
- To export it: set mcp_export.enabled: true in config.yaml, then run `ethos mcp serve --personality outbound-gated`.
