...
export const SYSTEM_PERSONALITY_IDS = new Set(['personality-architect', 'team-architect']);
// ---------------------------------------------------------------------------
...
function isStorageLike(v) {
  return (
    !!v && typeof v === 'object' && typeof v.read === 'function' && typeof v.write === 'function'
  );
}
// ---------------------------------------------------------------------------
// Helpers
...
function buildSafetyConfig(raw) {
  ...
  if (obs) {
    ...
    if (obs.storeToolArgs !== undefined) {
      ...
      observability.storeToolArgs = obs.storeToolArgs;
    }
    if (obs.storeToolBodies !== undefined) {
      ...
      observability.storeToolBodies = obs.storeToolBodies;
    }
    if (obs.storeLlmPayloads !== undefined) {
      ...
      observability.storeLlmPayloads = obs.storeLlmPayloads;
    }
