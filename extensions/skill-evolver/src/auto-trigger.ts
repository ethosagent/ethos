...
export interface SkillEvolutionAutoTriggerOptions {
  hooks: HookRegistry;
...
export function resetSkillEvolutionCooldowns(): void {
  cooldowns.clear();
}
...
function renderCandidate(input: CandidateInput): string {
