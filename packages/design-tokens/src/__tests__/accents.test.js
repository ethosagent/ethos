...
import { accentFor, BUILTIN_PERSONALITY_IDS, DEFAULT_TOKENS, isBuiltinPersonality, personalityAccent, } from '../index';
...
describe('BUILTIN_PERSONALITY_IDS', () => {
    it('lists the five DESIGN.md personalities', () => {
        expect([...BUILTIN_PERSONALITY_IDS].sort()).toEqual(['coach', 'engineer', 'operator', 'researcher', 'reviewer'].sort());
    });
});
