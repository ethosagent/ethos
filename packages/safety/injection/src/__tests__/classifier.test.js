...
function makeStubProvider(reply) {
    return {
        name: 'stub',
        model: 'haiku',
...
describe('createLLMClassifier', () => {
    it('parses a clean JSON verdict', async () => {
        const llm = makeStubProvider('{"containsInstructions": true, "confidence": 0.9, "reason": "role-override"}');
