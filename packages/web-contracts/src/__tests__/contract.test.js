...
import { ApprovalRequestSchema, contract, PersonalitySchema, SessionSchema, SseEventSchema, } from '../index';
// ---------------------------------------------------------------------------
...
describe('SSE event union', () => {
    ...
    it('rejects an unknown discriminator', () => {
        expect(() => SseEventSchema.parse({ type: 'not_a_real_event', text: 'x' })).toThrow();
    });
